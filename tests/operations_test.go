...
func TestDistinct(t *testing.T) {
	t.Run("Remove duplicates", func(t *testing.T) {
		data := From([]int{1, 2, 2, 3, 3, 3, 4, 4, 4, 4})
...
func TestChunk(t *testing.T) {
	...
	t.Run("Uneven chunks", func(t *testing.T) {
		...
		// Check last chunk has only 1 element
		if len(result[2]) != 1 {
